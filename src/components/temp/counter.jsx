...
class Counter extends Component {
    ...
    render() {
        ...
        return (
            <div> 
                <span className="badge badge-light">{counter.label} Notification count {counter.value}</span>
                <button className="btn btn-sm btn-primary" onClick={ ()=> onIncrement(counter)}> 
                ...
                <button className="btn btn-sm btn-warning" onClick={ ()=> onDecrement(counter)}> 
                ...
                <button className="btn btn-sm btn-danger" onClick={()=> onDelete(counter)}> 
